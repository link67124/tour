...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'index777data/index777_messages_','.xml');
	krpanoLoaded = true;
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"index777data/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"index777data/graphics/KolorMenu/KolorMenu.min.js", [], true);
